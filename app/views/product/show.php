                ...
                <div class="row">
                    <div class="col-md-6">
                        <?php if ($product->image): ?>
                            <img src="/2280618888_PhamTaManhLan_Bai2/<?php echo htmlspecialchars($product->image, ENT_QUOTES, 'UTF-8'); ?>"
                                class="img-fluid rounded"
                                alt="<?php echo htmlspecialchars($product->name, ENT_QUOTES, 'UTF-8'); ?>">
                        <?php else: ?>
                            <img src="/2280618888_PhamTaManhLan_Bai2/images/no-image.png" class="img-fluid rounded"
                                alt="Không có ảnh">
                        <?php endif; ?>
                    </div>
                    <div class="col-md-6">
