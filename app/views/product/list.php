...
<a href="/2280618888_PhamTaManhLan_Bai2/product/add" class="btn btn-success mb-2">Thêm sản phẩm mới</a>
<ul class="list-group">
    <?php foreach ($products as $product): ?>
        <li class="list-group-item">
            <h2> <a href="/2280618888_PhamTaManhLan_Bai2/product/show/<?php echo $product->id; ?>">
            ...
            <a href="/2280618888_PhamTaManhLan_Bai2/product/delete/<?php echo $product->id; ?>" class="btn btn-danger"
