        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                ...
                <ul class="list-unstyled mb-0">
                    <li><a href="/2280618888_PhamTaManhLan_Bai2/product/" class="text-dark">Danh sách sản phẩm</a></li>
                    <li><a href="/2280618888_PhamTaManhLan_Bai2/product/add" class="text-dark">Thêm sản phẩm</a></li>
                </ul>
            </div>
            <!-- Cột mạng xã hội -->
            <div class="col-lg-3 col-md-6 mb-4">
