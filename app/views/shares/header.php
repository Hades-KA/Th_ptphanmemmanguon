...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="/2280601348_TruongVanHuu_Bai2/product/">Danh sách sản phẩm</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/2280601348_TruongVanHuu_Bai2/product/add">Thêm sản phẩm</a>
            </li>
        </ul>
    </div>
</nav>
